...
<html>
<head>
	<title>Choose your favorite actors, actresses, and directors</title>
</head>
<body>

<button type="button" id="startButton" onclick="subFunction()">Start</button>
	<form id="searchForm">
		<label for="actor">Choose an actor:</label>
		<select id="actorDrop" name="actor"></select>

		<label for="actress">Choose an actress:</label>
		<select id="actressDrop" name="actress"></select>

		<label for="director">Choose a director:</label>
		<select id="directorDrop" name="director"></select>
